...
class FrameSupervisor:
    def __init__(self, month, **kwargs):
        ...
        self.num_nodes = int(self._data_kwargs.get('num_nodes',113))
        self.input_dim = int(self._data_kwargs.get('input_dim',8))
        ...
        model = Framework(**self._model_kwargs)
        print(model)

        self.hagen_model = model
